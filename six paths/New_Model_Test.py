...
for k in range(1,22,1):
    ...
    path1="/root/data/eyob_data/new_model/images/21_pairs_tno/Enh_VIS/"
    path2="/root/data/eyob_data/new_model/images/21_pairs_tno/ORG_IR/"
    
    path3="/root/data/eyob_data/new_model/images/21_pairs_tno/Enh_VIS/"
    path4="/root/data/eyob_data/new_model/images/21_pairs_tno/ORG_IR/"
